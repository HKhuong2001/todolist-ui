...
var chrome_js_1 = require("selenium-webdriver/chrome.js");
(function testChrome() {
    return __awaiter(this, void 0, void 0, function () {
        var driver, options, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    options = new chrome_js_1.Options();
                ...
                case 2:
                    ...
                    // Mở trang web và kiểm tra
                    return [4 /*yield*/, driver.get("https://www.google.com")];
                case 3:
                    // Mở trang web và kiểm tra
                    _a.sent();
                    console.log("✅ Đã mở Google thành công!");
                ...
                case 5:
                    error_1 = _a.sent();
                    console.error("❌ Lỗi xảy ra: ", error_1);
                    return [3 /*break*/, 9];
                case 6:
                    if (!driver) return [3 /*break*/, 8];
